...
(Adapted for use in the Master's project "Post-Hoc Analysis and Optimisation of a Longitudinal Alzheimer’s Disease Prediction Model via Optimal Reaction Coordinates")
